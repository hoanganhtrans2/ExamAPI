...
namespace DAL
{
    ...
    public partial class ThiTiengAnhDbContext : DbContext
    {
        public ThiTiengAnhDbContext()
            : base("name=ThiTiengAnhDbContext")
        {
        }
        ...
        public virtual DbSet<PhieuDuThi> PhieuDuThis { get; set; }
